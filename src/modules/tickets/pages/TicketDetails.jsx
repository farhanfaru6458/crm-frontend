...
const TicketDetails = () => {
  ...
  const [ticket, setTicket] = useState(
    MOCK_TICKETS.find((t) => t._id === id) || MOCK_TICKETS[2],
  );
  ...
  const handleEditSave = (e) => {
    e.preventDefault();
    setIsEditTicketDrawerOpen(false);
  };
  ...
  return (
    <div className={styles.container}>
      <Link to="/tickets" className={styles.breadcrumb}>
        <svg
        ...
        <aside className={styles.leftSidebar}>
          <div className={styles.card}>
            <div className={styles.profileTop}>
              <div>
                <h2 className={styles.companyTitle}>{ticket.name}</h2>
                <p className={styles.industrySub}>Status : {ticket.status}</p>
              </div>
            </div>
            ...
            <div className={styles.detailsList}>
              <div className={styles.detailItem}>
                <span className={styles.detailLabel}>Ticket Description</span>
                <span className={styles.detailValue}>{ticket.description}</span>
              </div>

              <div className={styles.detailItem}>
                <span className={styles.detailLabel}>Ticket Owner</span>
                <span className={styles.detailValue}>{ticket.owner}</span>
              </div>
              ...
              <div className={styles.detailItem}>
                ...
                <span className={styles.detailValue}>{ticket.createdAt}</span>
              </div>
            </div>
          </div>
        </aside>
        ...
        <aside className={styles.rightSidebar}>
          <div className={styles.aiSummaryCard}>
            ...
            <div className={styles.aiContent}>
              The ticket titled "{ticket.title}" currently has{" "}
              {activities.length} associated activities.
            </div>
          </div>
